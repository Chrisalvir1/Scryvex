...
function createDnsCache() {
    return new cacheable_lookup_1.default({
        maxTtl: 60,
        fallbackDuration: 0,
    });
}
...
const defaultRequestOptions = {
    ...
    responseType: 'json',
    method: 'GET',
    agent: { http: new agentkeepalive_1.default(), https: new agentkeepalive_1.HttpsAgent() },
}, ringErrorCodes = {
    7050: 'NO_ASSET',
    7019: 'ASSET_OFFLINE',
...
function requestWithRetry(requestOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const options = Object.assign(Object.assign(Object.assign({}, defaultRequestOptions), { dnsCache }), requestOptions), { headers, body } = (yield got_1.default(options)), data = body;
            ...
            if (!e.response) {
                ...
                if (e.code === 'ENOTFOUND' ||
                    e.code === 'EREFUSED' ||
                    e.code === 'ENETUNREACH') {
                    const url = url_1.parse(requestOptions.url);
                    util_1.logDebug(`Resetting DNS Cache.  DNS Cache for ${url.hostname}: ${JSON.stringify(yield dnsCache
                        .query(url.hostname)
...
class RingRestClient {
    ...
    request(options) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const hardwareId = yield hardwareIdPromise, url = options.url, initialSessionPromise = this.sessionPromise;
            try {
