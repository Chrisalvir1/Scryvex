...
class RtpHeader {
    ...
    serialize(size) {
        ...
        utils_1.setBit(v_p_x_cc, this.version, 1);
        if (this.padding)
            utils_1.setBit(v_p_x_cc, 1, 2);
        if (this.extensions.length > 0)
            this.extension = true;
        if (this.extension)
            utils_1.setBit(v_p_x_cc, 1, 3);
        utils_1.setBit(v_p_x_cc, this.csrc.length, 4, 4);
        buf.writeUInt8(v_p_x_cc.ref, offset++);
        const m_pt = { ref: 0 };
        if (this.marker)
            utils_1.setBit(m_pt, 1, 0);
        utils_1.setBit(m_pt, this.payloadType, 1, 7);
